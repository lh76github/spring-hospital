    ...
    <div class="container">
        <div class="card">
            ...
            <form method="POST">
                ...
                <button type="submit" name="dateBtn" class="btn btn-dark mb-3">Enregistrer</button>
                <a class="btn btn-outline-dark mb-3" href="liste-rendez-vous.php" role="button">Liste des rdv</a>
            </form>
        </div>
